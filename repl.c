...
/*         statement->type = STATEMENT_INSERT;
        ...
        if (strlen(statement->row_to_insert.username) > COLUMN_USERNAME_SIZE || strlen(statement->row_to_insert.email) >COLUMN_EMAIL_SIZE ) {
            return PREPARE_STRING_TOO_LONG;
        } */
        //return PREPARE_SUCCESS;
    }
...
ExecuteResult execute_insert(Statement* statement, Table* table) {
    ...
    // get node to judge if the node page is full.
